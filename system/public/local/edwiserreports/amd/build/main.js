...
define([
    ...
    './dashboardui' // <-- Add dashboardui module
], function(
    $,
    ModalFactory,
    Notification,
    ...
    courseengagement,
    certificatestats,
    dashboardui // <-- Add dashboardui param
) {
    ...
    var init = function() {
        $(document).ready(function() {
            ...
            // Initialize insights.
            insights.init(); // Remove this, handled by dashboardui.js

            // Initialize dashboard UI (dropdowns, Insights button, etc.)
            dashboardui.init(document);
    ...
    // Export dashboardui for testability (optional)
    return {
        init: init,
