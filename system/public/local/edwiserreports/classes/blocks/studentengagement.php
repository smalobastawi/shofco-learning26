...
class studentengagement extends block_base {
    ...
    public function get_summary_data($filters, $filterdata = true) {
        ...
        $spenttime = isset($timespentonsite->timespent) ? ($rtl ? date('s:i:H', mktime(0, 0, (int)$timespentonsite->timespent)) : date('H:i:s', mktime(0, 0, (int)$timespentonsite->timespent)) ) : '00:00:00';
