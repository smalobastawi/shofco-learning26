    ...
    public function get_data($filters, $table = true) {
        ...
        foreach (array_keys($coursemodules) as $cmid) {
            ...
            $data = [
                ...
                'maxgrade' => round(empty($grade->grademax) ? 0 : $grade->grademax, 2),
                'passgrade' => round(empty($grade->gradepass) ? 0 : $grade->gradepass, 2),
                'averagegrade' => round(empty($grade->avggrades) ? 0 : $grade->avggrades, 2),
                'highestgrade' => round(empty($grade->highestgrade) ? 0 : $grade->highestgrade, 2),
                'lowestgrade' => round(empty($grade->lowestgrade) ? 0 : $grade->lowestgrade, 2),
