...
$string['customreportfullnamewarning'] = 'Only letters, numbers and spaces are allowed in report name';
...
$string['totalactivitieswithcompletion'] = 'Total activities with completion';
$string['totalcompletions'] = 'Total completions';
$string['overallcompletionrate'] = 'Overall completion rate';
