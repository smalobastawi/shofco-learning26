...
<li>Course end date {$a->courseenddate}</li>
...
$string['customwelcomemessageplaceholder'] = 'Hi {$a->firstname}, you are enrolled in the course {$a->coursename}. The course starts on {$a->coursestartdate} and ends on {$a->courseenddate}.';
