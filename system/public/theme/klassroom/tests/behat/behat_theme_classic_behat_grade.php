...
/**
 * Behat grade related step definition overrides for the klassroom theme.
 *
...
/**
 * Behat grade overrides for the klassroom theme.
 *
 * @package    theme_klassroom
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_klassroom_behat_grade extends behat_grade {
